...
var MAIL_TO = "something@gmail.com";
...
var MAIL_DIRECT_STUDENT_INVITATION = "Olá,{@courseName}, {@courseEvaluationLink}\n\n";

var aNames = [
  {course: "GEX107 - Computação gráfica - 7ª e 10ª Fase - Vespertino e Noturno", name: "FERNANDO BEVILACQUA"}
];